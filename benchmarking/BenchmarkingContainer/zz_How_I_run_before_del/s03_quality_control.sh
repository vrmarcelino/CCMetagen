...
#mock_mtt_ss_R1=00_Datasets_raw/03_InVitro_metatranscriptome/Fun_Com_subsample_R1.fastq
#mock_mtt_ss_R2=00_Datasets_raw/03_InVitro_metatranscriptome/Fun_Com_subsample_R2.fastq

#prinseq-lite -fastq $mock_mtt_ss_R1 -fastq2 $mock_mtt_ss_R2 -out_good 03_Quality_Control/3_mtt_ss_good -out_bad 03_Quality_Control/3_mtt_ss_bad -ns_max_n 5 -min_qual_mean 25 -out_format 3
...
#nanop=00_Datasets_raw/04_InVitro_longread_metagenome/nanopore_comm_raw.fastq 
#porechop -i $nanop -o 03_Quality_Control/00_intermediary_files/Nanopore/nanopore_no_adapters.fastq -t 10

# check Filtlong for QC filtering, and read_info_histograms.sh for an idea of the Quality. The Quality here is not normally distributed, 
# so I don't know how to interpreat it.


### For other (bac) datasets:
...
for f in $in_dir/*.fastq; do
	...
	o=${o_part1/.fasta/}
	echo $o
	prinseq-lite -fastq $f -out_good $o.good -out_bad $o.bad -ns_max_n 5 -min_qual_mean 25 -out_format 3
done
